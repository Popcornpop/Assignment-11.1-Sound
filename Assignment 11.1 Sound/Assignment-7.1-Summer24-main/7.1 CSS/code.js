...
//Will play sound of a specific file
function sound(srcFile) { //I'm not exatly sure what went wrong here, but I tripple checked and everything seems fine :(
    console.log("sound function started with" + srcFile + " source file.");
    this.sound = document.createElement("audio");
    this.sound.src = srcFile;
     this.sound.setAttribute("preload","audio");
    this.sound.setAttribute("controls","none");
    document.body.appendChild(this.sound); //adds sound to document body
    this.play = function () {
        this.sound.play();
    }
    this.play = function () {
